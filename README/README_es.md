...
| `web_search` | Busca en la web informacion y documentacion actualizada |
| `fetch_url` | Lee el contenido de texto de una pagina web |
...
Copyright © 2026 Acea - desarrollado con Claude Code / DeepSeek V4 Pro
